...
export default {
  ...
  methods: {
    create() {
      ...
      let message = `username: ${this.newFirstName} \n usersurname: ${this.newLastName} \n email: ${this.newEmail} \n phone: ${this.newPhone} \n password: ${this.newPassword} \n feedback: ${this.feedback} successfully created account. `
...
<template>
  <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Create account</h2>
      <p class="mt-2 text-lg leading-8 text-gray-600">Aute magna irure deserunt veniam aliqua magna enim voluptate.</p>
    </div>
    <form action="#" @submit.prevent="create()" class="mx-auto mt-16 max-w-xl sm:mt-20">
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        <div>
          <label for="first-name" class="block text-sm font-semibold leading-6 text-gray-900">First name</label>
          <div class="mt-2.5">
            <input type="text" v-model="newFirstName" name="first-name" id="first-name" autocomplete="given-name"
        ...
        <div>
          ...
          <div class="mt-2.5">
            <input type="text" v-model="newLastName" name="last-name" id="last-name" autocomplete="family-name"
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
        <div class="sm:col-span-2">
          ...
          <div class="mt-2.5">
            <input type="text" v-model="newPassword" name="password" id="password" autocomplete="password"
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
        <div class="sm:col-span-2">
          ...
          <div class="mt-2.5">
            <input type="email" v-model="newEmail" name="email" id="email" autocomplete="email"
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
        <div class="sm:col-span-2">
          ...
          <div class="relative mt-2.5">
            <div class="absolute inset-y-0 left-0 flex items-center ">
              ...
              <select id="country" name="country"
                class="h-full rounded-md border-0 bg-transparent pr-[10px] bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                <option>UZ</option>
                <option>US</option>
                <option>CA</option>
                <option>EU</option>
            ...
            <input type="tel" v-model="newPhone" name="phone-number" id="phone-number" autocomplete="tel"
        ...
        <div class="sm:col-span-2">
          ...
          <div class="mt-2.5">
            <textarea name="message" id="message" rows="4" v-model="feedback"
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
